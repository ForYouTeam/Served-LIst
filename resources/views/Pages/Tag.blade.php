                ...
                <ul class="nav nav-tabs  tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#form" role="tab" aria-expanded="false"><i
                                class="fa-solid fa-plus"></i> Tambah Tag</a>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content tabs card-block">
                    <div class="mt-2 tab-pane active" id="table" role="tabpanel" aria-expanded="true">
                        <blockquote class="blockquote">
                            ...
                            <footer class="blockquote-footer">Tabel Data Tag
                            </footer>
                        </blockquote>
                    ...
                    <div class="tab-pane" id="form" role="tabpanel" aria-expanded="false">
                        ...
                        <form id="form-simpan" class="row" style="padding: 8px 100px 9px;">
                            ...
                            <div class="col-md-12 form-group">
                                <label class="col-form-label">Nama Tag</label>
                                <input name="nama_tag" type="text" class="form-control mt-2" placeholder="klik disini!"
                                    autocomplete="off">
                                <small class="text-danger" id="nama_tag-alert"></small>
                            </div>
                            <div class="col-md-12 form-group">
                                <label class="col-form-label">Deskripsi</label>
                                <textarea rows="5" cols="5" name="deskripsi" class="form-control"
                                    placeholder="klik disini!"></textarea>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn-simpan', function() {
            let url = `{{ config('app.url') }}` + "/api/tag";
            ...
            $.ajax({
                ...
                error: function(result) {
                    ...
                    if (errorRes.length >= 1) {
                        $('.miniAlert').html('');
                        $('#nama_tag-alert').html(errorRes.data.nama_tag);
                        $('#deskripsi-alert').html(errorRes.data.deskripsi);
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            let url = `{{ config('app.url') }}/api/tag/${_id}`;
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    <div class="row card-body" style="padding: 30px 120px 42px">
                        <div class="col-md-12 form-group">
                            <label class="col-form-label">Nama Tag</label>
                            <input type="hidden" id="idTag" value="${_id}">
                            <input name="nama_tag" type="text" class="form-control mt-2"
                                placeholder="klik disini!" autocomplete="off" value="${result.data.nama_tag}">
                        </div>
                        <div class="col-md-12 form-group">
                            <label class="col-form-label">Deskripsi</label>
                            <textarea rows="5" cols="5" name="deskripsi" class="form-control" placeholder="klik disini!">${result.data.deskripsi}</textarea>
                        </div>
                        <div class="col-md-12 form-group">
                            <label class="col-form-label">Color</label>
